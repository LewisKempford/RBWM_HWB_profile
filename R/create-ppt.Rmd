...
x$Colour <- NA
x$Colour[x$Quintile == 1] <- "#b3c7f7"
x$Colour[x$Quintile == 2] <- "#8babf1"
x$Colour[x$Quintile == 3] <- "#0073e6"
x$Colour[x$Quintile == 4] <- "#0461cf"
x$Colour[x$Quintile == 5] <- "#054fb9"
x$Colour[x$Quintile == "Not compared"] <- "grey"

x$Colour <- factor(x$Colour, c("#b3c7f7", "#8babf1", "#0073e6", "#0461cf",
                               "#054fb9", "grey"))
...
outfile <- paste0("../output/RBWM-JLHWB-profile-", format(version_num, nsmall = 1), ".pptx")
