...
ph_copyright <- paste0("Version ", format(version_num, nsmall = 1), " \uA9 RBWM Public Health Team, ", format(Sys.Date(), "%d/%m/%Y"))
...
```{r title.people.and.place, eval = incl_title.people.and.place}
