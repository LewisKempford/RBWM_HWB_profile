...
title <- paste0("Emergency hospital admissions for all causes, ",
                tolower(ind_sex), ", ", tolower(ind_age))
short_title <- paste0("Emergency admissions for all causes (", ind_age, ")")
additional_text <- NULL
notes <- NULL
...
title <- paste0("EEmergency hospital admissions for coronary heart disease, ",
                tolower(ind_sex), ", ", tolower(ind_age))
short_title <- paste0("Emergency admissions for CHD (", ind_age, ")")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Persons"
ind_age <- "All ages"
title <- paste0("EEmergency hospital admissions for stroke, ",
                tolower(ind_sex), ", ", tolower(ind_age))
short_title <- paste0("Emergency admissions for stroke (", ind_age, ")")
additional_text <- NULL
notes <- NULL
