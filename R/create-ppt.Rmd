...
ind_sex <- "Persons"
ind_age <- "2 yrs"
title <- paste0("	MMR vaccination for one dose (2 years) (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("MMR vaccination for one dose (2 years)")
...
# temp fix
i <- x$Timeperiod <= max(x$Timeperiod[x$AreaType == "GPs"])
x <- x[i, ]
