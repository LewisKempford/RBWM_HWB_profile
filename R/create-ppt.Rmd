...
context <- paste0("MMR is the combined vaccine that protects against measles, mumps and rubella. The Department of Health have adoped the World Health Organisation's 95% target for vaccination coverage at national and local levels")
...
# temp fix
i <- x$Timeperiod <= max(x$Timeperiod[x$AreaType == "GP"])
x <- x[i, ]
...
context <- paste0("The combined DTaP/IPV/Hib is the first in a course of vaccines offered to babies to protect them against diphtheria, pertussis (whooping cough), tetanus, Haemophilus influenzae type b and polio. The Department of Health have adoped the World Health Organisation's 95% target for vaccination coverage at national and local levels")
value_type <- "Proportion (%)"
value_type_short <- "%"
timeperiod <- "financial years"
original_geography <- "GP"
...
metadata <- text_metadata(value_type = value_type, 
                          original_geography = original_geography, 
                          benchmarking_method = confidence_interval_method,
                          source = source)
...
short_title <- paste0("Asthma: QOF prevalence")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Persons"
ind_age <- "All ages"
title <- paste0("Cancer: QOF prevalence (", tolower(ind_sex), "), (", tolower(ind_age), ")")
...
ind_sex <- "Persons"
ind_age <- "All ages"
title <- paste0("Atrial fibrillation: QOF prevalence (", tolower(ind_sex), "), (", tolower(ind_age), ")")
...
short_title <- paste0("Depression: QOF incidence - new diagnosis")
additional_text <- NULL
notes <- NULL
...
short_title <- paste0("Smoking: QOF prevalence")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Female"
ind_age <- "25-49 yrs"
title <- paste0("Cervical screening coverage: aged 25 to 49 years old (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("Cervical screening coverage: aged 25 to 49 years old")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Female"
ind_age <- "50-64 yrs"
title <- paste0("Cervical screening coverage: aged 50 to 64 years old (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("Cervical screening coverage: aged 50 to 64 years old")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Persons"
ind_age <- "16+ yrs"
title <- paste0("% with caring responsibility (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("% with caring responsibility")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Persons"
ind_age <- "50+ yrs"
title <- paste0("Osteoporosis: QOF prevalence (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("Osteoporosis: QOF prevalence")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Persons"
ind_age <- "16+ yrs"
title <- paste0("Rheumatoid arthritis: QOF prevalence (", tolower(ind_sex), "), (", tolower(ind_age), ")")
...
ind_sex <- "Persons"
ind_age <- "60-74 yrs"
title <- paste0("Bowel cancer screening coverage: aged 60 to 74 years old (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("Bowel cancer screening coverage: aged 60 to 74 years old")
additional_text <- NULL
notes <- NULL
...
ind_sex <- "Persons"
ind_age <- "53-70 yrs"
title <- paste0("Breast screening coverage: aged 53 to 70 years old (", tolower(ind_sex), "), (", tolower(ind_age), ")")
short_title <- paste0("Breast screening coverage: aged 53 to 70 years old")
additional_text <- NULL
notes <- NULL
