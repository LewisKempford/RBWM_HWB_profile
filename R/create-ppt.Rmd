...
#### RBWM lsoas ###
i <- data$AreaCode %in% rbwm_lsoas & data$Timeperiod == 2023
x <- data[i, ]
...
x$Colour <- NA
x$Colour[x$Quintile == levels(x$Quintile)[1]] <- "#c4b0c7"
x$Colour[x$Quintile == levels(x$Quintile)[2]] <- "#a384a8"
x$Colour[x$Quintile == levels(x$Quintile)[3]] <- "#6f2277"
x$Colour[x$Quintile == levels(x$Quintile)[4]] <- "#581b5e"
x$Colour[x$Quintile == levels(x$Quintile)[5]] <- "#431347"
x$Colour[x$Quintile == "Not compared"] <- "grey"

x$Colour <- factor(x$Colour, c("#c4b0c7", "#a384a8", "#6f2277", "#581b5e",
                               "#431347", "grey"))
